class Restaurant:
    ...
    def __init__(self, name):                       # ID, Food Name,  Quantity,  Discount,   Price,   Stock
        self.name=name
        self.food={1: {'Name': 'Biryani', 'Quantity': 6.0, 'Price': 150.0, 'Discount': 80.0, 'Stock': 7.0}, 
                   2: {'Name': 'Butter masala', 'Quantity': 5.0, 'Price': 200.0, 'Discount': 70.0, 'Stock': 6.0},
                   3: {'Name': 'aalo sabji', 'Quantity': 1.0, 'Price': 420.0, 'Discount': 40.0, 'Stock': 10.0}, 
                   4: {'Name': 'mix veg', 'Quantity': 5.0, 'Price': 500.0, 'Discount': 30.0, 'Stock': 4.0},
                   5: {'Name': 'Rice', 'Quantity': 1.0, 'Price': 420.0, 'Discount': 20.0, 'Stock': 3.0}, 
                   6: {'Name': 'Veg Gobi', 'Quantity': 1.0, 'Price': 100.0, 'Discount': 60.0, 'Stock': 4.0},
                   7: {'Name': 'Masala Dosa', 'Quantity': 1.0, 'Price': 90.0, 'Discount': 40.0, 'Stock': 7.0}, 
                   8: {'Name': 'vadapao', 'Quantity': 1.0, 'Price': 70.0, 'Discount': 50.0, 'Stock': 6.0},
                   9: {'Name': 'pau bhaji', 'Quantity': 2.0, 'Price': 260.0, 'Discount': 20.0, 'Stock': 7.0}, 
                   10: {'Name': 'gujarati sabji', 'Quantity': 1.0, 'Price': 200.0, 'Discount': 60.0, 'Stock': 6.0},
                   11: {'Name': 'Sheshwan Noodle', 'Quantity': 1.0, 'Price': 380.0, 'Discount': 70.0, 'Stock': 7.0}, 
                   12: {'Name': 'Shawarma', 'Quantity': 2.0, 'Price': 320.0, 'Discount': 20.0, 'Stock': 5.0}}
        self.food_ID=len(self.food)+1
        self.user_details={1: {"User Name" : "Abhishek Pandya", "Phone No." :9033635600, "Email_ID" : 'abhi@gmail.com', 'Password' : 'noiceone', 'Address' : "Gujarat"},
                           2: {"User Name" : "Meet Pandya", "Phone No." : 1234567890, "Email_ID" : 'meet@food.com', 'Password' : 'noiceone', 'Address' : "maharasrea"}}
        self.admin_details={1: {"Admin Name" :  "Abhishek Pandya", "Phone No." :9033635600, "Email_ID" : 'abhi@gmail.com', 'Password' : 'noiceone', 'Address' : "Gujarat"}}
...
try:
    def main():
        instance= Restaurant("khana da dhaba")
